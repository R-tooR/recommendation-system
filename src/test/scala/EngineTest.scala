...
class EngineTest  extends AnyPropSpec with should.Matchers {
...
//  implicit val engine: Arbitrary[recommendation.Engine] = Arbitrary {
//    new recommendation.Engine
//  }

//  property("find most similar investors") = forAll { (e: recommendation.Engine) => {
